      ...
      <ul className="space-y-3 lg:flex lg:items-center lg:gap-6 lg:space-y-0">
        <li>
          <Link
            ...
            activeProps={{
              className:
                "text-red-600 bg-red-50 lg:bg-transparent lg:after:content-[''] lg:after:absolute lg:after:-bottom-1 lg:after:left-0 lg:after:w-full lg:after:h-0.5 lg:after:bg-red-600",
            }}
            inactiveProps={{
              className:
