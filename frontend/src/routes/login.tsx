...
function RouteComponent() {
  return (
    <>
      <MinimalHeader />
      <main className="to-avpn-green/20 grow bg-linear-to-br from-red-300/10 via-orange-50 px-4 py-10">
        <div className="space-y-4 rounded-lg border border-gray-100 bg-white px-4 py-6 text-center shadow-lg">
